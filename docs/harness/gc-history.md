...
| 2026-07-12 21:15:44 | — | — | — | — | — | DONE | gc.sh: PASS ruff check WARN ruff format (advisory) PASS pytest+cov PASS vulture PASS benchmarks PASS verify-docs SKIP python -m build (build 미설치) |
